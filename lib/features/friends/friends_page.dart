  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(Iconsax.search_normal_1, color: context.colors.hint),
        filled: true,
    ...
    if (incoming.isEmpty && sent.isEmpty) {
      return Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Iconsax.people, size: 56, color: context.colors.hint),
            SizedBox(height: 12),
            Text(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Iconsax.clock_1, size: 12, color: context.colors.primary),
                SizedBox(width: 4),
                Text(
                  'friends.pending'.tr(),
                  style: TextStyle(
