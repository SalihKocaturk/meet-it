...
class _VenueRatingPageState extends ConsumerState<VenueRatingPage> {
  ...
  Future<void> _submit() async {
    ...
    QuickAlert.show(
      ...
      text: 'venue_rating.rating_shared_desc'.tr(
        namedArgs: {'venue': widget.venueName},
      ),
      confirmBtnColor: context.colors.primary,
      onConfirmBtnTap: () {
              ...
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return GestureDetector(
                      onTap: () =>
                          setState(() => _selectedFriend = isSel ? null : f),
                      child: Column(
